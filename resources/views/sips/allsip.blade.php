...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <form method="GET" action="{{ route('employees.allsip') }}" class="d-flex align-items-center gap-2"
